  ...
  <div class="email-container">
    ...
    <div class="footer">
      ...
      <div class="unsubscribe-section">
        <p style="margin:0 0 10px 0;font-size:15px;color:#333;font-weight:500;">Don't want to receive these emails?</p>
        <a href="${unsubscribeUrl}" class="unsubscribe-button">🚫 Unsubscribe</a>
        <p class="unsubscribe-note">You'll be taken to our unsubscribe page to confirm</p>
      </div>
      <div class="copyright">
